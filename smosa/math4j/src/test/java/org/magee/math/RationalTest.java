...
public class RationalTest {
    ...
    //during the execution of the method add()
    @Test
    ...
    //this test also exercise the method doubleValue()
    @Test
    ...
    //This test exercise the add() and the longValue() method
    ...
    public void addTestWithInteger() throws Throwable{
        Rational rational0 = new Rational(1L,1L);
        rational0.add(1L);
        assertEquals("Numerator value expected different",2L,rational0.numerator);
        assertEquals("Long Value expected different",2,rational0.longValue());
    }
    ...
    //This test also exercise the longValue() and the floatValue() method
    @Test
    ...
    @Test
    public void reduceTestInteger() throws Throwable {
    ...
    @Test
    public void reduceTestNonInteger() throws Throwable {
    ...
    // This method exercise the method negate() with a positive rational number
    @Test
    public void test08()  throws Throwable  {
        Rational rational0 = new Rational(887L, 887L);
        Rational rational1 = rational0.negate();
        assertEquals("Negation Rational value expected different",(byte) (-1), rational1.byteValue());
        assertEquals("Input Rational value expected different",1, rational0.intValue());
    }
    // This method exercise the method negate() with a negative rational number
    @Test
    public void negateTestNegative()  throws Throwable  {
        Rational rational0 = new Rational(-887L, 887L);
        Rational rational1 = rational0.negate();
        assertEquals("Negation Rational value expected different",(byte) (1), rational1.byteValue());
        assertEquals("Input Rational value expected different",-1, rational0.intValue());
    ...
    // This method exercise the method abs() with a positive rational non-integer number
    @Test
    ...
    public void testByteValue() throws Throwable {
        ...
        assertEquals(7772L,rational0.byteValue());
    }
}